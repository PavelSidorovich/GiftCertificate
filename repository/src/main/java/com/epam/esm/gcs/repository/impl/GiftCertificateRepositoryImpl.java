...
//import com.epam.esm.gcs.repository.GiftCertificateRepositoryOld;
...
//        implements GiftCertificateRepositoryOld {
//
...
////    private FilterQueryGenerator<SearchFilter> filterQueryGenerator;
//
...
//
////    @Autowired
////    public void setFilterQueryGenerator(FilterQueryGenerator<SearchFilter> filterQueryGenerator) {
...
//
//    /**
//     * Finds certificates according to provided searchFilter
//     *
//     * @param searchFilter  certificate searchFilter
//     * @param limiter query limiter
//     * @return list of certificates found by searchFilter
//     */
//    @Override
//    public List<GiftCertificateModel> findByFilter(SearchFilter searchFilter, Limiter limiter) {
////        String sqlQuery = filterQueryGenerator.getSqlQuery(searchFilter);
